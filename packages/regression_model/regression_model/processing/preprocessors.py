...
class NumericalImputer(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series=None) -> "NumericalImputer":
        # persist mode values in a dictionary
        self.imputer_dict_ = {}
        for feature in self.variables:
...
class LogTransformer(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series) -> "LogTransformer":
...
class DropUnecessaryFeatures(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series) -> "DropUnecessaryFeatures":
        return self
